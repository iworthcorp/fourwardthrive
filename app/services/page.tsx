  ...
  return (
    <>
      ...
      <section className="relative overflow-hidden max-w-6xl mx-auto px-6 md:px-10 pt-20 pb-12 md:pt-28 text-center">
        ...
        <p className="relative text-sm font-medium text-noir-primary mb-4 tracking-wide uppercase" data-reveal>Services</p>
        ...
        <p className="relative mt-6 max-w-xl mx-auto text-noir-deep/60 leading-relaxed" data-reveal style={{ transitionDelay: "160ms" }}>
          From clinics and franchises to IT solutions and communities — here are some of the businesses we&apos;ve provided digital marketing and business solutions for.
        </p>
      </section>
      ...
      <section className="py-10 md:py-16 border-y border-noir-line" data-reveal>
        ...
        <div className="relative">
          ...
          <Marquee items={CLIENTS} itemClassName={PILL_CLASS} className="px-6 md:px-10" />
        </div>
      </section>
    </>
  );
