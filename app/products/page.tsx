  ...
  return (
    <>
      ...
      <section className="relative overflow-hidden max-w-6xl mx-auto px-6 md:px-10 pt-20 pb-12 md:pt-28 text-center">
        ...
        <p className="relative text-sm font-medium text-noir-primary mb-4 tracking-wide uppercase" data-reveal>Products</p>
        ...
        <p className="relative mt-6 max-w-xl mx-auto text-noir-deep/60 leading-relaxed" data-reveal style={{ transitionDelay: "160ms" }}>
          From wellness essentials to lifestyle products, we&apos;ve helped bring these brands to market with marketing strategy and digital presence.
        </p>
      </section>
      ...
      <section className="py-10 md:py-16 border-y border-noir-line" data-reveal>
        ...
        <div className="relative">
          ...
          <Marquee items={PRODUCTS} itemClassName={PILL_CLASS} className="px-6 md:px-10" />
        </div>
      </section>
    </>
  );
